...
- Developed **CHATGURU** — one of the first Hindi-language AI apps — from concept to App Store & Play Store launch
- Integrated OpenAI API for conversational AI in Hindi
...
**B.Tech in Data Science & Artificial Intelligence** — BML Munjal University *(Oct 2021 – Jun 2025)*
...
<div align="center">
  <i>I'm looking for engineering roles where I can own backend systems end-to-end,<br>solve hard infrastructure problems, and build products that scale.</i>
  <br><br>
  <b>⚡ Building systems that move fast and scale hard.</b>
</div>
